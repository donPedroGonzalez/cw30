...
{   
    ...
    questionsToFind = [ "Zadawanie pytań z inwersją", "Comment vous appelez-vous", "Où habitez-vous", "Quelles langues parlez-vous", "Quel âge avez-vous", "De quelle nationalité êtes-vous" ];
    answersProvided = [ "Pytania typu *Qui êtes-vous ?*", "Je m'appelle Marcin.", "J'habite à Sucha Górna.", "Je parle polonais et anglais.", "J'ai 53 ans.", "Je suis polonais." ];
    hints = [ "Questions", "Jak się Pan/Pani nazywa?", "Gdzie Pan/Pani mieszka?", "Jakimi językami Pan/Pani mówi?", "Ile ma Pan/Pani lat?", "Jakiej jest Pan/Pani narodowości?" ];
